...
public class Settings_Tick extends BaseTest {

    AndroidDriver<AndroidElement> driver = capabilities();
    ButtonAndTexts buttonAndTexts = new ButtonAndTexts(driver);
    TimeOut timeOut = new TimeOut();

    public Settings_Tick() throws MalformedURLException {
    }
    ...
    @Test
    public void settingsTickTest() {
        buttonAndTexts.btnClick(Locators.leftSidebar);
        timeOut.timeOut();
        buttonAndTexts.BtnSClick(Locators.allSidebarMenu, 7);
        timeOut.timeOut();
        buttonAndTexts.btnClick(Locators.tick_untick);
        timeOut.timeOut();
    }
