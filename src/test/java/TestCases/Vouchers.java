...
public class Vouchers extends BaseTest {

    AndroidDriver<AndroidElement> driver = capabilities();
    ButtonAndTexts buttonAndTexts = new ButtonAndTexts(driver);
    TimeOut timeOut = new TimeOut();

    public Vouchers() throws MalformedURLException {
    }
    ...
    public void favTest() {
        buttonAndTexts.btnClick(Locators.leftSidebar);
        timeOut.timeOut();
        buttonAndTexts.BtnSClick(Locators.allSidebarMenu, 5);
        timeOut.timeOut();
        buttonAndTexts.btnClick(Locators.past);
        timeOut.timeOut();
